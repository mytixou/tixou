...
class DepartementResourceIT {
    ...
    public static Departement createEntity(EntityManager em) {
        Departement departement = new Departement().nom(DEFAULT_NOM).code(DEFAULT_CODE);
        return departement;
    }
    ...
    public static Departement createUpdatedEntity(EntityManager em) {
        Departement departement = new Departement().nom(UPDATED_NOM).code(UPDATED_CODE);
        return departement;
    }
    ...
    void putNewDepartement() throws Exception {
        ...
        updatedDepartement.nom(UPDATED_NOM).code(UPDATED_CODE);
    ...
    void partialUpdateDepartementWithPatch() throws Exception {
        ...
        partialUpdatedDepartement.nom(UPDATED_NOM).code(UPDATED_CODE);
