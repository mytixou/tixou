...
export class NatureActiviteComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-nature-activite div table .btn-danger'));
  title = element.all(by.css('jhi-nature-activite div h2#page-heading span')).first();
...
export class NatureActiviteUpdatePage {
  pageTitle = element(by.id('jhi-nature-activite-heading'));
...
export class NatureActiviteDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-natureActivite-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-natureActivite'));
