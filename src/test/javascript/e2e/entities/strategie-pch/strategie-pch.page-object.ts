...
export class StrategiePchComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-strategie-pch div table .btn-danger'));
  title = element.all(by.css('jhi-strategie-pch div h2#page-heading span')).first();
...
export class StrategiePchUpdatePage {
  pageTitle = element(by.id('jhi-strategie-pch-heading'));
...
export class StrategiePchDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-strategiePch-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-strategiePch'));
