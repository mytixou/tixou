...
describe('Proprietaire Management Component', () => {
  let comp: ProprietaireComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProprietaireComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.proprietaires[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
